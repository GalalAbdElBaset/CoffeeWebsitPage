...
if (!loggedInUser && currentPage !== "sign-in.html" && currentPage !== "sign-up.html") {
  ...
  popup.innerHTML = `
    <div class="popup-inner">
      <i class="fa-solid fa-lock fa-2x" style="color:#ff9800;"></i>
      <p>You need to sign in to access this page.</p>
      <button id="go-login">Go to Sign In</button>
    </div>
  `;
...
if (loggedInUser) {
  ...
  if (usernameDisplayNav) {
    usernameDisplayNav.textContent = `Hi, ${loggedInUser.username}`;
...
function initializeItem1() {
  ...
  <img src="../img/menu/CaffeAmericanoh.jpg" alt="product" />
    <div>
...
function initializeItem2() {
  ...
  <img src="../img/menu/CaffeMisto.jpg" alt="product" />
    <div>
...
function initializeItem3() {
  ...
  <img src="../img/menu/BlondeCaffeAmericano.jpg" alt="product" />
    <div>
...
function initializeItem4() {
  ...
  <img src="../img/menu/BlondeRoast.jpg" alt="product" />
    <div>
...
function initializeItem5() {
  ...
  <img src="../img/menu/DarkRoastCoffee.jpg" alt="product" />
    <div>
...
function initializeItem6() {
  ...
  <img src="../img/menu/PikePlaceRoast.jpg" alt="product" />
    <div>
...
function initializeItem7() {
  ...
  <img src="../img/menu/DecafPikePlaceRoast.jpg" alt="product" />
    <div>
...
function initializeItem11() {
  ...
  <img src="../img/menu/EspressoMacchiato.jpg" alt="product" />
    <div>
...
function initializeItem12() {
  ...
  <img src="../img/menu/FlatWhite.webp" alt="product" />
    <div>
